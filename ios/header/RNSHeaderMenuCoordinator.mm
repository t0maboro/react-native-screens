...
@implementation RNSHeaderMenuCoordinator
...
+ (UIMenu *)buildMenuFromData:(RNSHeaderMenuData *)data
              withHeaderEventsDelegate:(id<RNSHeaderEventsDelegate>)delegate
                          stateTracker:(RNSHeaderMenuToggleStateTracker *)tracker
                   singleSelectionRoot:(nullable RNSHeaderMenuData *)singleSelectionRoot
               ...
               menuInvalidatedCallback:(nullable void (^)(void))onMenuInvalidated
{
  ...
  RNSHeaderMenuData *resolvedRoot = singleSelectionRoot;
  ...
  for (id<RNSHeaderMenuElement> child in data.children) {
  ...
  if (data.icon != nil) {
    UIImage *syncImage = [RNSHeaderIconResolver resolveIcon:data.icon
                                            withImageLoader:imageLoader
    ...
    menuImage = syncImage ? syncImage : [RNSHeaderIconResolver placeholderImageForIcon:data.icon];
  }
...
+ (nullable UIMenuElement *)buildElementFromData:(id<RNSHeaderMenuElement>)element
                        withHeaderEventsDelegate:(id<RNSHeaderEventsDelegate>)delegate
                                    stateTracker:(RNSHeaderMenuToggleStateTracker *)tracker
                                      parentMenu:(RNSHeaderMenuData *)parentMenu
                             singleSelectionRoot:(nullable RNSHeaderMenuData *)singleSelectionRoot
              initialSingleSelectionStateClaimed:(BOOL *)initialSingleSelectionStateClaimed
                                 withImageLoader:(id<RNSImageLoading>)imageLoader
                         menuInvalidatedCallback:(nullable void (^)(void))onMenuInvalidated
{
  if ([element isKindOfClass:[RNSHeaderMenuData class]]) {
    return [self buildMenuFromData:(RNSHeaderMenuData *)element
                  withHeaderEventsDelegate:delegate
                              stateTracker:tracker
  ...
  if ([element isKindOfClass:[RNSHeaderMenuItemData class]]) {
    RNSHeaderMenuItemData *itemData = (RNSHeaderMenuItemData *)element;
 ...
 */
+ (nullable UIMenuElement *)buildToggleFromData:(RNSHeaderMenuItemData *)data
                                 withParentMenu:(RNSHeaderMenuData *)parentMenu
                            singleSelectionRoot:(nullable RNSHeaderMenuData *)singleSelectionRoot
                             toggleStateTracker:(RNSHeaderMenuToggleStateTracker *)tracker
                           headerEventsDelegate:(id<RNSHeaderEventsDelegate>)delegate
                                withImageLoader:(id<RNSImageLoading>)imageLoader
                        menuInvalidatedCallback:(nullable void (^)(void))onMenuInvalidated
{
  ...
  __weak id<RNSHeaderEventsDelegate> weakDelegate = delegate;
  ...
  if (data.icon != nil) {
    ...
    iconImage = syncImage ? syncImage : [RNSHeaderIconResolver placeholderImageForIcon:data.icon];
  }
           ...
           identifier:nil
              handler:^(__kindof UIAction *_Nonnull action) {
                NSArray<NSString *> *toggleItemsIds = insideSingleSelection
                    ? [RNSHeaderMenuCoordinator getAllToggleItemsIdsInSingleSelectionHierarchy:singleSelectionRoot]
                    : [RNSHeaderMenuCoordinator getToggleItemsIdsInMenu:parentMenu];
...
+ (nullable UIMenuElement *)buildActionFromData:(RNSHeaderMenuItemData *)data
                       withHeaderEventsDelegate:(id<RNSHeaderEventsDelegate>)delegate
                                withImageLoader:(id<RNSImageLoading>)imageLoader
                        menuInvalidatedCallback:(nullable void (^)(void))onMenuInvalidated
{
...
+ (void)collectToggleItemsIdsFromMenu:(RNSHeaderMenuData *)menu
                ...
                insideSingleSelection:(bool)insideSingleSelection
{
  for (id<RNSHeaderMenuElement> child in menu.children) {
    if ([child isKindOfClass:[RNSHeaderMenuItemData class]]) {
      RNSHeaderMenuItemData *item = (RNSHeaderMenuItemData *)child;
      RNSMenuItemType effectiveItemType = [self resolveItemType:item.itemType
                                          insideSingleSelection:insideSingleSelection];
      if (effectiveItemType == RNSMenuItemTypeToggle) {
        [ids addObject:item.menuElementId];
      }
    } else if (insideSingleSelection && [child isKindOfClass:[RNSHeaderMenuData class]]) {
      [self collectToggleItemsIdsFromMenu:(RNSHeaderMenuData *)child
                                intoArray:ids
                    insideSingleSelection:insideSingleSelection];
    }
  }
...
+ (void)decorateActionKeepsMenuPresented:(UIAction *)action withData:(RNSHeaderMenuItemData *)data
{
...
{
  BOOL changed = NO;
  NSMutableArray<id<RNSHeaderMenuElement>> *newChildren = [NSMutableArray arrayWithCapacity:menu.children.count];

  for (id<RNSHeaderMenuElement> child in menu.children) {
    if ([child.menuElementId isEqualToString:elementId]) {
      [newChildren addObject:newElement];
      changed = YES;
    } else if ([child isKindOfClass:[RNSHeaderMenuData class]]) {
      RNSHeaderMenuData *rebuilt = [self menu:(RNSHeaderMenuData *)child
  ...
  return [[RNSHeaderMenuData alloc] initWithId:menu.menuElementId
                                         title:menu.title
