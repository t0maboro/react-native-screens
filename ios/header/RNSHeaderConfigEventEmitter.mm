...
@implementation RNSHeaderConfigEventEmitter {
  std::shared_ptr<const react::RNSHeaderConfigIOSEventEmitter> _reactEventEmitter;
}
...
- (void)updateEventEmitter:(const std::shared_ptr<const react::RNSHeaderConfigIOSEventEmitter> &)emitter
{
