                                                           ...
                                                           RNSHeaderIconData *_Nullable fallback)
{
  ...
  return [RNSHeaderIconMapper iconFromDictionary:value] ?: fallback;
}
...
+ (instancetype)fromDictionary:(NSDictionary *)dict
{
  ...
  RNSHeaderIconData *icon = hasIcon ? RNSResolveIconFromDict(dict, @"icon", nil) : nil;
...
+ (RNSHeaderMenuData *)applyOptions:(RNSMenuUpdateOptions *)options toMenu:(RNSHeaderMenuData *)old
{
  ...
  return [[RNSHeaderMenuData alloc] initWithId:old.menuElementId
                                         title:title
